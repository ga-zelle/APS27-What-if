...
def setVariant(stmp):
    ...
    new_parameter['CheckLibreError'] = True            ### add'l parameter: AAPS 2.7 is at True for the stupid Dexcm CGM errr handler
...
def scanLogfile(fn, entries):
    ...
    key_270 = '[DetermineBasalAdapterSMBJS.invoke():163]: Result:'                  # V2.7   flag for Result record
    global lcount
                ...
                if headerKey == '::. ':
                    ...
                    or Block2 == '[DataService.onHandleIntent():69]':             # token :54 added for AAPS versions <2.7, :69 for V2.7
                        ...
                        if dataType_offset <-99:                            # not yet initialized for known AAPS version
                            ...
                            elif dataType != 163:   print('row', str(lcount), 'unhandled dataType: '+str(dataType)) # any but 2.7 RESULT
                        ...
                        #print (str(lcount), str(dataType), str(dataType_offset), dataStr[:60], '\n')
                        ...
                        elif dataType == dataType_offset+144:               checkCarbsNeeded(dataStr[8:], lcount)   # result record in AAPS2.6.1
